...
import '@appuniversum/ember-appuniversum/styles/_index.scss';
import '@lblod/ember-rdfa-editor/ember-rdfa-editor.scss';
...
export default RouteTemplate(ApplicationRoute) as unknown;
